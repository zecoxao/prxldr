...
const size_t g_sceLibc_cnt = sizeof(g_sceLibc) / sizeof(g_sceLibc[0]);


const SyslibEntry g_sceLibm[] = {
...
const size_t g_sceLibm_cnt = sizeof(g_sceLibm) / sizeof(g_sceLibm[0]);


const SyslibEntry g_syslib[] = {
...
const size_t g_syslib_cnt = sizeof(g_syslib) / sizeof(g_syslib[0]);
